...
// Schedule section funcitonality
...
async function init() {
  const leaderboardData = await fetchSheetData("B213:D222");
  // const leaderboardDataS1 = await fetchSheetData("B225:D234");
  const leaderboardDataF1 = await fetchSheetData("B225:D234");
